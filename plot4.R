plot4 <- function() 
   { 
     ...
     # plot 2 graph in top left
     plot(pcdate$Date_Time, pcdate$Global_active_power, xaxt=NULL, xlab="", ylab = "Global Active Power", type = "n" ) 
     lines(pcdate$Date_Time, pcdate$Global_active_power, type="S")
     
     
     # plot graph in top right
     plot(pcdate$Date_Time, pcdate$Voltage, xaxt=NULL, xlab="datetime", ylab = "Voltage", type = "n" ) 
     lines(pcdate$Date_Time, pcdate$Voltage, type="S")
     
     
     # plot 3 graph in bottom left
     ...
     plot(pcdate$Date_Time, pcdate$Global_reactive_power, xaxt=NULL, xlab="datetime", ylab = "Global_reactive_power", type = "n" ) 
     lines(pcdate$Date_Time, pcdate$Global_reactive_power, type="S")
